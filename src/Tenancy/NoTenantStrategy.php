 ...
 * is already present on the authenticated card (a claim JwtAuthMiddleware
 ...
 * never present — and today's card-model multi-tenant (T2) platforms — where
 * tenant_id already arrives on the card itself — continue to work exactly as
